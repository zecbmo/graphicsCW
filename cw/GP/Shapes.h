...
enum ShapesType {DISC, SPHERE, CUBE_ST, CUBE_CT, PLANE, PLANE_TILED, PLANE_BIG, SPHERE_HALF_UV};
...
private:
	...
	void InitBigPlane(float resolution = 1); //resolution equals one as the default plane won't tile
